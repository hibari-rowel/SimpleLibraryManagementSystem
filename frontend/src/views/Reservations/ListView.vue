<script setup lang="ts">
    ...
    const datatableID = 'reservations-list';
    const header = {
        module: 'Reservations',
        icon: 'nav-icon fas fa-solid fa-calendar-alt',
        bread_crumbs: [
            {name: "Reservations", is_active: true,}
        ]
    }
    ...
    const datatableProps = {
        ...
        drawCallback: function () {
            const table = document.querySelector('#reservations-list');
                        ...
                        defaultSweetAlert.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                try {
                                    ...
                                    $('#reservations-list').DataTable().ajax.reload(null, false);
                                } catch (err) {
                                    Swal.fire({
                                        title: 'Error!',
...
<template>
    <base-template :header="header">
        <template v-slot:button>
            <RouterLink :to="'/reservations/create'" class="btn font-weight-bolder btn-primary">
                Create
            </RouterLink>
        </template>
